...
function install-packages {
  ...
  go test -i github.com/xcloudnative/xspace-console/src/app/backend/...
  echo "OK!"
}
...
function run-coverage-tests {
  ...
  for PKG in $(go list github.com/xcloudnative/xspace-console/src/app/backend/... | grep -v vendor); do
