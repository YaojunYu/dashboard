...
* Follow the [Getting started guide](https://github.com/kubernetes/dashboard/blob/master/docs/devel/getting-started.md) to get the most recent version of Dashboard up and running.
