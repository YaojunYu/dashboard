!function(e, t) {
  'object' == typeof exports&& 'undefined' != typeof module ?
      module.exports = t() :
      'function' == typeof define && define.amd ? define(t) : e.Sweetalert2 = t()
}(this,
  function() {
    'use strict';
    var e = {
      ...
      onClose: null
        ...
        o = n([
          ...
          'progresssteps',  'activeprogressstep',
        ...
        i =
          ...
          e.length < 6 && (e = e[0] + e[0] + e[1] + e[1] + e[2] + e[2]), t = t || 0;
          for (var n = '#', o = 0; o < 3; o++) {
        ...
        l =
          ...
          n ||
              (console.warn('SweetAlert2: Can\'t find the target "' + e.target + '"'),
               n = document.body),
              n.appendChild(t);
          var r = c(), i = A(r, o.input), a = A(r, o.file),
              l = r.querySelector('.' + o.range + ' input'),
              u = r.querySelector('.' + o.range + ' output'), d = A(r, o.select),
              p = r.querySelector('.' + o.checkbox + ' input'), f = A(r, o.textarea);
        ...
        s = ('\n <div  role="dialog" aria-labelledby="modalTitleId" aria-describedby="modalContentId" class="' +
             o.modal + '" tabIndex="-1" >\n   <ul class="' + o.progresssteps +
             '"></ul>\n   <div class="' + o.icon + ' ' + r.error +
             '">\n     <span class="x-mark"><span class="line left"></span><span class="line right"></span></span>\n   </div>\n   <div class="' +
             o.icon + ' ' + r.question + '">?</div>\n   <div class="' + o.icon + ' ' + r.warning +
             '">!</div>\n   <div class="' + o.icon + ' ' + r.info + '">i</div>\n   <div class="' +
             o.icon + ' ' + r.success +
             '">\n     <span class="line tip"></span> <span class="line long"></span>\n     <div class="placeholder"></div> <div class="fix"></div>\n   </div>\n   <img class="' +
             o.image + '">\n   <h2 class="' + o.title +
             '" id="modalTitleId"></h2>\n   <div id="modalContentId" class="' + o.content +
             '"></div>\n   <input class="' + o.input + '">\n   <input type="file" class="' +
             o.file + '">\n   <div class="' + o.range +
             '">\n     <output></output>\n     <input type="range">\n   </div>\n   <select class="' +
             o.select + '"></select>\n   <div class="' + o.radio + '"></div>\n   <label for="' +
             o.checkbox + '" class="' + o.checkbox +
             '">\n     <input type="checkbox">\n   </label>\n   <textarea class="' + o.textarea +
             '"></textarea>\n   <div class="' + o.validationerror + '"></div>\n   <hr class="' +
             o.spacer + '">\n   <button type="button" role="button" tabIndex="0" class="' +
             o.confirm +
             '">OK</button>\n   <button type="button" role="button" tabIndex="0" class="' +
             o.cancel + '">Cancel</button>\n   <span class="' + o.close +
             '">&times;</span>\n </div>\n')
                .replace(/(^|\n)\s*/g, ''),
        u = function() {
          ...
          var n = [b(), w()];
          return e && n.reverse(),
                 n.concat(Array.prototype.slice.call(c().querySelectorAll(
                     'button:not([class^=' + t + ']), input:not([type=hidden]), textarea, select')))
        }, x = function(e, t) {
          ...
          if ('function' == typeof MouseEvent) {
            ...
            document.createEventObject ? e.fireEvent('onclick') :
          ...
          if (e) return 0;
          var t = document.createElement('div');
          t.style.width = '50px', t.style.height = '50px', t.style.overflow = 'scroll',
          ...
          var n = c() || l(t);
          for (var i in t)
            e.hasOwnProperty(i) || 'extraParams' === i ||
                console.warn('SweetAlert2: Unknown parameter "' + i + '"');
          n.style.width = 'number' == typeof t.width ? t.width + 'px' : t.width,
          n.style.padding = t.padding + 'px', n.style.background = t.background;
          var a = f(), s = m(), u = b(), p = w(), g = C();
          if (t.titleText ? a.innerText = t.titleText :
            ...
            T(s);
          t.showCloseButton ? P(g) : T(g), n.className = o.modal,
                                           t.customClass && E(n, t.customClass);
          var x = y(),
              S = parseInt(
                  null === t.currentProgressStep ? X.getQueueStep() : t.currentProgressStep, 10);
          t.progressSteps.length ?
              (P(x), L(x),
               S >= t.progressSteps.length &&
                   console.warn(
               ...
               t.progressSteps.forEach(function(e, n) {
                 ...
                 if (E(r, o.progresscircle), r.innerHTML = e, n === S && E(r, o.activeprogressstep),
                     x.appendChild(r), n !== t.progressSteps.length - 1) {
          ...
          if (t.type) {
            ...
            switch (P(H), t.type) {
              case 'success':
                E(H, 'animate'), E(H.querySelector('.tip'), 'animate-success-tip'),
                    E(H.querySelector('.long'), 'animate-success-long');
                break;
              case 'error':
          ...
          var I = v();
          t.imageUrl ?
              (I.setAttribute('src', t.imageUrl), P(I),
               t.imageWidth ? I.setAttribute('width', t.imageWidth) : I.removeAttribute('width'),
               t.imageHeight ? I.setAttribute('height', t.imageHeight) :
                               I.removeAttribute('height'),
               I.className = o.image, t.imageClass && E(I, t.imageClass)) :
              T(I),
              t.showCancelButton ? p.style.display = 'inline-block' : T(p),
                                   t.showConfirmButton ? q(u, 'display') : T(u);
          var N = h();
          t.showConfirmButton || t.showCancelButton ? P(N) : T(N),
              u.innerHTML = t.confirmButtonText, p.innerHTML = t.cancelButtonText,
              t.buttonsStyling &&
              (u.style.backgroundColor = t.confirmButtonColor,
               p.style.backgroundColor = t.cancelButtonColor),
              u.className = o.confirm, E(u, t.confirmButtonClass), p.className = o.cancel,
              E(p, t.cancelButtonClass),
              t.buttonsStyling ?
              (E(u, o.styled), E(p, o.styled)) :
              (B(u, o.styled), B(p, o.styled),
              ...
              t.animation === !0 ? B(n, o.noanimation) : E(n, o.noanimation)
        }, z = function(e, t) {
          var n = u(), r = c();
          e ? (E(r, o.show), E(n, o.fade), B(r, o.hide)) : B(r, o.fade), P(r),
              ...
              E(document.documentElement, o.shown), E(document.body, o.shown), E(n, o.shown), Q(),
              Z(), a.previousActiveElement = document.activeElement,
              null !== t && 'function' == typeof t && setTimeout(function() {
                t(r)
              })
        }, Q = function() {
          null === a.previousBodyPadding && document.body.scrollHeight > window.innerHeight &&
          ...
          if (x(document.body, o.iosfix)) {
            ...
            B(document.body, o.iosfix), document.body.style.top = '',
          ...
          switch (j(n[0])) {
            case 'string':
              l.title = n[0], l.html = n[1], l.type = n[2];
              break;
            case 'object':
              K(l, n[0]), l.extraParams = n[0].extraParams,
                          'email' === l.input && null === l.inputValidator &&
          ...
          return new Promise(function(t, n) {
            l.timer && (d.timeout = setTimeout(function() {
                          e.closeModal(l.onClose), n('timer')
                        }, l.timer));
            var r = function(e) {
              if (e = e || l.input, !e) return null;
              switch (e) {
                case 'select':
                case 'textarea':
                case 'file':
                  return A(d, o[e]);
                case 'checkbox':
                  return d.querySelector('.' + o.checkbox + ' input');
                case 'radio':
                  return d.querySelector('.' + o.radio + ' input:checked') ||
                      d.querySelector('.' + o.radio + ' input:first-child');
                case 'range':
                  return d.querySelector('.' + o.range + ' input');
                default:
                  return A(d, o.input)
              }
            }, p = function() {
            ...
            for (var x =
                     ...
                     L =
                         function(t) {
                           var o = t || window.event, r = o.target || o.srcElement, a = b(),
                               s = w(), u = a === r || a.contains(r), c = s === r || s.contains(r);
                           switch (o.type) {
                             case 'mouseover':
                             case 'mouseup':
                               l.buttonsStyling &&
                                   (u ? a.style.backgroundColor = i(l.confirmButtonColor, -.1) :
                                        c &&
                                            (s.style.backgroundColor =
                                                 i(l.cancelButtonColor, -.1)));
                               break;
                             case 'mouseout':
                               l.buttonsStyling &&
                                   (u ? a.style.backgroundColor = l.confirmButtonColor :
                                        c && (s.style.backgroundColor = l.cancelButtonColor));
                               break;
                             case 'mousedown':
                               l.buttonsStyling &&
                                   (u ? a.style.backgroundColor = i(l.confirmButtonColor, -.2) :
                                        c &&
                                            (s.style.backgroundColor =
                                                 i(l.cancelButtonColor, -.2)));
                               break;
                             case 'click':
                               u && e.isVisible() ?
                                   (e.disableButtons(),
                                    l.input ?
                                        !function() {
                                          ...
                                          l.inputValidator ?
                                              (e.disableInput(),
                                               l.inputValidator(t, l.extraParams)
                                                   .then(
                                                       function() {
                                                         e.enableButtons(), e.enableInput(), x(t)
                                                       },
                                                       function(t) {
                                        ...
                                        x(!0)) :
                                   c && e.isVisible() &&
                                       (e.disableButtons(), e.closeModal(l.onClose), n('cancel'))
                           }
                         },
                     q = d.querySelectorAll('button'), O = 0;
                 O < q.length; O++)
              q[O].onclick = L, q[O].onmouseover = L, q[O].onmouseout = L, q[O].onmousedown = L;
            C().onclick = function() {
              e.closeModal(l.onClose), n('close')
            }, s.onclick = function(t) {
              t.target === s && l.allowOutsideClick && (e.closeModal(l.onClose), n('overlay'))
            };
            var H = b(), I = w();
            ...
            var K = function(e, t) {
              ...
              if ([9, 13, 32, 27].indexOf(r) !== -1) {
                for (var i = o.target || o.srcElement, a = k(l.focusCancel), s = -1, u = 0;
                     u < a.length; u++)
                  if (i === a[u]) {
                    s = u;
                    break
                ...
                9 === r ?
                    (o.shiftKey ? K(s, -1) : K(s, 1), o.stopPropagation(), o.preventDefault()) :
                    13 === r || 32 === r ?
                    s === -1 && l.allowEnterKey && (l.focusCancel ? V(I, o) : V(H, o)) :
                    27 === r && l.allowEscapeKey === !0 && (e.closeModal(l.onClose), n('esc'))
              }
            };
            a.previousWindowKeyDown = window.onkeydown, window.onkeydown = D,
            l.buttonsStyling &&
                (H.style.borderLeftColor = l.confirmButtonColor,
                 H.style.borderRightColor = l.confirmButtonColor),
            e.showLoading = e.enableLoading = function() {
              P(h()), P(H, 'inline-block'), E(H, o.loading), E(d, o.loading), H.disabled = !0,
                                                                              I.disabled = !0
            }, e.hideLoading = e.disableLoading = function() {
              l.showConfirmButton || (T(H), l.showCancelButton || T(h())), B(H, o.loading),
                  B(d, o.loading), H.disabled = !1, I.disabled = !1
            }, e.getTitle = function() {
              return f()
              ...
              if (!e) return !1;
              if ('radio' === e.type)
                for (var t = e.parentNode.parentNode, n = t.querySelectorAll('input'), o = 0;
                     o < n.length; o++)
                  n[o].disabled = !1;
              else
                e.disabled = !1
              ...
              if (e && 'radio' === e.type)
                ...
                e.disabled = !0
                 ...
                 if (e) {
                   ...
                   e.style.minHeight = '', P(e), e.style.minHeight = e.scrollHeight + 1 + 'px',
                   e.style.display = t
                 }
            ...
            for (var W = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
                     Q = void 0, Y = 0;
                 Y < W.length; Y++) {
              var Z = o[W[Y]], J = A(d, Z);
              if (Q = r(W[Y])) {
                for (var X in Q.attributes)
                  if (Q.attributes.hasOwnProperty(X)) {
                    var $ = Q.attributes[X].name;
                    'type' !== $ && 'value' !== $ && Q.removeAttribute($)
                  }
                for (var _ in l.inputAttributes) Q.setAttribute(_, l.inputAttributes[_])
              }
              J.className = Z, l.inputClass && E(J, l.inputClass), T(J)
            }
            var F = void 0;
            !function() {
              switch (l.input) {
                ...
                case 'number':
                case 'tel':
                  Q = A(d, o.input), Q.value = l.inputValue, Q.placeholder = l.inputPlaceholder,
                  Q.type = l.input, P(Q);
                  break;
                case 'file':
                  Q = A(d, o.file), Q.placeholder = l.inputPlaceholder, Q.type = l.input, P(Q);
                  break;
                case 'range':
                  var e = A(d, o.range), t = e.querySelector('input'),
                      n = e.querySelector('output');
                  t.value = l.inputValue, t.type = l.input, n.value = l.inputValue, P(e);
                  break;
                case 'select':
                  var i = A(d, o.select);
                  if (i.innerHTML = '', l.inputPlaceholder) {
                    var a = document.createElement('option');
                    a.innerHTML = l.inputPlaceholder, a.value = '', a.disabled = !0,
                    a.selected = !0, i.appendChild(a)
                  }
                  F = function(e) {
                    for (var t in e) {
                      var n = document.createElement('option');
                      n.value = t, n.innerHTML = e[t], l.inputValue === t && (n.selected = !0),
                      i.appendChild(n)
                    }
                    P(i), i.focus()
                  };
                ...
                case 'radio':
                  var s = A(d, o.radio);
                  s.innerHTML = '', F = function(e) {
                    for (var t in e) {
                      var n = document.createElement('input'), r = document.createElement('label'),
                          i = document.createElement('span');
                      n.type = 'radio', n.name = o.radio, n.value = t,
                      l.inputValue === t && (n.checked = !0), i.innerHTML = e[t], r.appendChild(n),
                      r.appendChild(i), r.for = n.id, s.appendChild(r)
                    }
                    P(s);
                  ...
                  break;
                case 'checkbox':
                  var u = A(d, o.checkbox), c = r('checkbox');
                  c.type = 'checkbox', c.value = 1, c.id = o.checkbox,
                  c.checked = Boolean(l.inputValue);
                  var p = u.getElementsByTagName('span');
                  p.length && u.removeChild(p[0]), p = document.createElement('span'),
                                                   p.innerHTML = l.inputPlaceholder,
                                                   u.appendChild(p), P(u);
                  break;
                case 'textarea':
                  var f = A(d, o.textarea);
                  f.value = l.inputValue, f.placeholder = l.inputPlaceholder, P(f);
                  break;
                case null:
                  break;
                default:
                ...
                (l.inputOptions instanceof Promise ?
                     (e.showLoading(), l.inputOptions.then(function(t) {
                       e.hideLoading(), F(t)
                     })) :
                ...
                l.allowEnterKey ? K(-1, 1) :
                                  document.activeElement && document.activeElement.blur(),
                u().scrollTop = 0,
                'undefined' == typeof MutationObserver || U ||
                (U = new MutationObserver(e.recalculateHeight),
                 U.observe(d, {childList: !0, characterData: !0, subtree: !0}))
          })
        };
    return X.isVisible = function() {
      ...
      return new Promise(function(e, o) {
        !function r(i, a) {
          i < W.length ? (document.body.setAttribute('data-swal2-queue-step', i),
                          X(W[i]).then(
                              function(e) {
                                n.push(e), r(i + 1, a)
                              },
      ...
      if (n) {
        ...
        var r = function() {
          t.parentNode.removeChild(t), B(document.documentElement, o.shown),
              B(document.body, o.shown), Y(), J()
        };
      ...
      if (!t || 'object' !== ('undefined' == typeof t ? 'undefined' : j(t)))
        return console.error(
            'SweetAlert2: the argument for setDefaults() is required and has to be a object');
      for (var n in t)
        e.hasOwnProperty(n) || 'extraParams' === n ||
            (console.warn('SweetAlert2: Unknown parameter "' + n + '"'), delete t[n]);
      K(D, t)
