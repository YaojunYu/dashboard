    ...
    function(t, e, n) {
      ...
      i.e = function(t, e) {
        ...
        return 'undefined' != typeof t.matches ?
            ...
            'undefined' != typeof t.msMatchesSelector ? t.msMatchesSelector(e) : void 0
      }, i.remove = function(t) {
    ...
    function(t, e, n) {
      ...
      n.extend = function(t, e) {
        ...
        return o.matches(t, 'input,[contenteditable]') ||
            ...
            o.matches(t, 'textarea,[contenteditable]') || o.matches(t, 'button,[contenteditable]')
        ...
        return l(o.css(t, 'width')) + l(o.css(t, 'paddingLeft')) + l(o.css(t, 'paddingRight')) +
            l(o.css(t, 'borderLeftWidth')) + l(o.css(t, 'borderRightWidth'))
  ...
  9: [
    function(t, e, n) {
      ...
      e.exports = function(t) {
        var e = l.get(t);
        e &&
            (e.event.unbindAll(), o.remove(e.scrollbarX), o.remove(e.scrollbarY),
             o.remove(e.scrollbarXRail), o.remove(e.scrollbarYRail), r.removePsClasses(t),
             l.remove(t))
      }
    },
    ...
    function(t, e, n) {
      ...
      function r(t, e) {
        ...
        e.event.bind(e.scrollbarX, 'mousedown', function(n) {
          ...
          l.startScrolling(t, 'x'), e.event.bind(e.ownerDocument, 'mousemove', s),
          e.event.once(e.ownerDocument, 'mouseup', u), n.stopPropagation(), n.preventDefault()
        })
      }
      function o(t, e) {
        function n(n) {
        ...
        e.event.bind(e.scrollbarY, 'mousedown', function(n) {
          ...
          l.startScrolling(t, 'y'), e.event.bind(e.ownerDocument, 'mousemove', s),
          e.event.once(e.ownerDocument, 'mouseup', u), n.stopPropagation(), n.preventDefault()
        })
      }
      var l = t('../../lib/helper'), i = t('../../lib/dom'), s = t('../instances'),
          a = t('../update-geometry'), c = t('../update-scroll');
      e.exports = function(t) {
        var e = s.get(t);
        r(t, e), o(t, e)
      }
        ...
        e.event.bind(e.ownerDocument, 'keydown', function(c) {
          if (!(c.isDefaultPrevented && c.isDefaultPrevented() || c.defaultPrevented)) {
            ...
            if (r || u) {
              ...
              a(t, 'top', t.scrollTop - f), a(t, 'left', t.scrollLeft + p), s(t),
                  i = n(p, f), i && c.preventDefault()
            }
          }
        })
      }
      var o = t('../../lib/helper'), l = t('../../lib/dom'), i = t('../instances'),
          s = t('../update-geometry'), a = t('../update-scroll');
      e.exports = function(t) {
        var e = i.get(t);
        r(t, e)
      }
          ...
          o(u, d) ||
              (a = !1,
               e.settings.useBothWheelAxes ?
                   ...
                   (d ? i(t, 'top', t.scrollTop - d * e.settings.wheelSpeed) :
                        i(t, 'top', t.scrollTop + u * e.settings.wheelSpeed),
                    a = !0) :
                   e.scrollbarXActive && !e.scrollbarYActive &&
                           (u ? i(t, 'left', t.scrollLeft + u * e.settings.wheelSpeed) :
      ...
      function r(t, e) {
        ...
        e.event.bind(e.ownerDocument, 'selectionchange', function() {
          ...
          if (d) {
            ...
            n.x<l.left + 3 ? (u.left = -5, o.startScrolling(t, 'x')) : n.x>l.right - 3 ?
  ...
  16: [
    function(t, e, n) {
      ...
      function r(t, e, n, r) {
        function o(n, r) {
          ...
          if (s > i) {
            if (r < 0 && o === e.contentHeight - e.containerHeight || r > 0 && 0 === o)
              ...
              i > s && (n < 0 && l === e.contentWidth - e.containerWidth || n > 0 && 0 === l))
            return !e.settings.swipePropagation;
          return !0
        }
        function a(e, n) {
        ...
        n &&
            (e.event.bind(window, 'touchstart', c), e.event.bind(window, 'touchend', u),
             e.event.bind(t, 'touchstart', f), e.event.bind(t, 'touchmove', h),
             e.event.bind(t, 'touchend', b)),
            r &&
            (window.PointerEvent ?
                 (e.event.bind(window, 'pointerdown', c), e.event.bind(window, 'pointerup', u),
                  e.event.bind(t, 'pointerdown', f), e.event.bind(t, 'pointermove', h),
                  e.event.bind(t, 'pointerup', b)) :
                 window.MSPointerEvent &&
                     (e.event.bind(window, 'MSPointerDown', c),
                      e.event.bind(window, 'MSPointerUp', u), e.event.bind(t, 'MSPointerDown', f),
                      e.event.bind(t, 'MSPointerMove', h), e.event.bind(t, 'MSPointerUp', b)))
      }
      var o = t('../../lib/helper'), l = t('../instances'), i = t('../update-geometry'),
          s = t('../update-scroll');
      e.exports = function(t) {
  ...
  18: [
    function(t, e, n) {
      ...
      function r(t) {
        ...
        var r = this;
        r.settings = s.clone(c), r.containerWidth = null, r.containerHeight = null,
        r.contentWidth = null, r.contentHeight = null, r.isRtl = 'rtl' === u.css(t, 'direction'),
        r.isNegativeScroll =
            function() {
        ...
        r.scrollbarXTop =
            r.isScrollbarXUsingBottom ? null : s.toInt(u.css(r.scrollbarXRail, 'top')),
        r.railBorderXWidth = s.toInt(u.css(r.scrollbarXRail, 'borderLeftWidth')) +
        ...
        r.scrollbarYLeft =
            r.isScrollbarYUsingRight ? null : s.toInt(u.css(r.scrollbarYRail, 'left')),
        r.scrollbarYOuterWidth = r.isRtl ? s.outerWidth(r.scrollbarY) : null,
        r.railBorderYWidth = s.toInt(u.css(r.scrollbarYRail, 'borderTopWidth')) +
      ...
      var s = t('../lib/helper'), a = t('../lib/class'), c = t('./default-setting'),
          u = t('../lib/dom'), d = t('../lib/event-manager'), p = t('../lib/guid'), f = {};
      n.add = function(t) {
        var e = p();
    ...
    function(t, e, n) {
      ...
      function r(t, e) {
        return t.settings.minScrollbarLength && (e = Math.max(e, t.settings.minScrollbarLength)),
               t.settings.maxScrollbarLength && (e = Math.min(e, t.settings.maxScrollbarLength)), e
      }
      function o(t, e) {
        var n = {width: e.railXWidth};
        e.isRtl ?
            n.left = e.negativeScrollAdjustment + t.scrollLeft + e.containerWidth - e.contentWidth :
            n.left = t.scrollLeft,
            e.isScrollbarXUsingBottom ? n.bottom = e.scrollbarXBottom - t.scrollTop :
                                        n.top = e.scrollbarXTop + t.scrollTop,
            s.css(e.scrollbarXRail, n);
        var r = {top: t.scrollTop, height: e.railYHeight};
        e.isScrollbarYUsingRight ?
            e.isRtl ? r.right = e.contentWidth - (e.negativeScrollAdjustment + t.scrollLeft) -
                    e.scrollbarYRight - e.scrollbarYOuterWidth :
                      r.right = e.scrollbarYRight - t.scrollLeft :
            e.isRtl ? r.left = e.negativeScrollAdjustment + t.scrollLeft + 2 * e.containerWidth -
                    e.contentWidth - e.scrollbarYLeft - e.scrollbarYOuterWidth :
      ...
      e.exports = function(t) {
        ...
        t.contains(e.scrollbarXRail) ||
            (n = s.queryChildren(t, '.ps-scrollbar-x-rail'), n.length > 0 && n.forEach(function(t) {
              s.remove(t)
            }),
             s.appendTo(e.scrollbarXRail, t)),
            t.contains(e.scrollbarYRail) ||
            (n = s.queryChildren(t, '.ps-scrollbar-y-rail'), n.length > 0 && n.forEach(function(t) {
              s.remove(t)
            }),
            ...
            (e.scrollbarYActive = !0, e.railYHeight = e.containerHeight - e.railYMarginHeight,
             e.railYRatio = e.containerHeight / e.railYHeight,
             e.scrollbarYHeight =
                 r(e, l.toInt(e.railYHeight * e.containerHeight / e.contentHeight)),
            ...
            (e.scrollbarYTop = e.railYHeight - e.scrollbarYHeight),
            o(t, e),
            e.scrollbarXActive ? i.add(t, 'ps-active-x') :
                                 (i.remove(t, 'ps-active-x'), e.scrollbarXWidth = 0,
                                  e.scrollbarXLeft = 0, c(t, 'left', 0)),
            e.scrollbarYActive ? i.add(t, 'ps-active-y') :
    ...
    function(t, e, n) {
      ...
      e.exports = function(t, e, n) {
        ...
        'top' === e && n >= s.contentHeight - s.containerHeight &&
            ...
            'top' === e && n<r && t.dispatchEvent(i('ps-scroll-up')), 'top' === e && n>r &&
            t.dispatchEvent(i('ps-scroll-down')),
            'left' === e && n<o && t.dispatchEvent(i('ps-scroll-left')), 'left' === e && n>o &&
      ...
      e.exports = function(t) {
        ...
        e &&
            (e.negativeScrollAdjustment = e.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0,
             ...
             e.railXMarginWidth = r.toInt(o.css(e.scrollbarXRail, 'marginLeft')) +
                 r.toInt(o.css(e.scrollbarXRail, 'marginRight')),
             e.railYMarginHeight = r.toInt(o.css(e.scrollbarYRail, 'marginTop')) +
                 r.toInt(o.css(e.scrollbarYRail, 'marginBottom')),
             o.css(e.scrollbarXRail, 'display', 'none'), o.css(e.scrollbarYRail, 'display', 'none'),
             i(t), s(t, 'top', t.scrollTop), s(t, 'left', t.scrollLeft),
             o.css(e.scrollbarXRail, 'display', ''), o.css(e.scrollbarYRail, 'display', ''))
      }
    },
    {
      '../lib/dom': 3,
