...
!function(a) {
  ...
  a.extend(a.fn, {
    validate: function(b) {
      ...
      return c ? c :
                 (this.attr('novalidate', 'novalidate'), c = new a.validator(b, this[0]),
                    ...
                    function d() {
                      ...
                      return c.settings.submitHandler ?
                          (c.submitButton &&
                           ...
                           c.submitButton && d.remove(), void 0 !== e ? e : !1) :
                          !0
                    }
                    return c.settings.debug && b.preventDefault(),
                           c.cancelSubmit ?
                               (c.cancelSubmit = !1, d()) :
                               c.form() ? c.pendingRequest ? (c.formSubmitted = !0, !1) : d() :
                                          (c.focusInvalid(), !1)
                  })), c)
    },
    valid: function() {
      ...
      return a(this[0]).is('form') ?
                 ...
                 (d = [], b = !0, c = a(this[0].form).validate(), this.each(function() {
    ...
    rules: function(b, c) {
      ...
      if (b)
        switch (d = a.data(j.form, 'validator').settings, e = d.rules,
      ...
      return g = a.validator.normalizeRules(
                 a.extend(
                     {}, a.validator.classRules(j), a.validator.attributeRules(j),
                     a.validator.dataRules(j), a.validator.staticRules(j)),
                 j),
             g.required &&
      ...
      a.validator = function(b, c) {
        ...
        defaults: {
            ...
            this.settings.focusCleanup &&
                (this.settings.unhighlight &&
                     this.settings.unhighlight.call(
                         this, a, this.settings.errorClass, this.settings.validClass),
          ...
          onkeyup: function(b, c) {
            ...
            9 === c.which && '' === this.elementValue(b) || -1 !== a.inArray(c.keyCode, d) ||
        ...
        prototype: {
          init: function() {
            function b(b) {
              var c = a.data(this.form, 'validator'), d = 'on' + b.type.replace(/^validate/, ''),
                  e = c.settings;
            ...
            this.containers =
                a(this.settings.errorContainer).add(this.settings.errorLabelContainer),
          ...
          element: function(b) {
            ...
            return this.lastElement = d,
                   void 0 === d ? delete this.invalid[c.name] :
                                  (this.prepareElement(d), this.currentElements = a(d),
                                   e = this.check(d) !== !1,
            ...
            for (d in f) {
              ...
              try {
                ...
                throw this.settings.debug && window.console &&
                    console.log(
                        'Exception occurred when checking element ' + b.id + ', check the \'' +
                            e.method + '\' method.',
                        j),
                    j instanceof TypeError &&
                    (j.message += '.  Exception occurred when checking element ' + b.id +
          ...
          defaultMessage: function(b, c) {
            return this.findDefined(
                this.customMessage(b.name, c), this.customDataMessage(b, c),
            ...
            for (a = 0; this.errorList[a]; a++)
              ...
              this.settings.highlight &&
                  this.settings.highlight.call(
                      this, c.element, this.settings.errorClass, this.settings.validClass),
            ...
            g.length ?
                ...
                (g = a('<' + this.settings.errorElement + '>')
                 ...
                 this.labelContainer.length ?
                     ...
                     this.settings.errorPlacement ? this.settings.errorPlacement(d, a(b)) :
                                                    d.insertAfter(b),
                 g.is('label') ? g.attr('for', h) :
                                 0 === g.parents('label[for=\'' + h + '\']').length &&
                         (f = g.attr('id').replace(/(:|\.|\[|\]|\$)/g, '\\$1'),
                          i ? i.match(new RegExp('\\b' + f + '\\b')) || (i += ' ' + f) : i = f,
                          a(b).attr('aria-describedby', i), e = this.groups[b.name],
                          e &&
                              a.each(
                                  this.groups,
                                  function(b, c) {
                                    c === e &&
                                        a('[name=\'' + b + '\']', this.currentForm)
                                            .attr('aria-describedby', g.attr('id'))
                                  }))),
                !c && this.settings.success &&
                (g.text(''),
                 'string' == typeof this.settings.success ? g.addClass(this.settings.success) :
        ...
        attributeRules: function(b) {
          ...
          for (c in a.validator.methods)
            'required' === c ? (d = b.getAttribute(c), '' === d && (d = !0), d = !!d) :
                               d = f.attr(c),
                 ...
                 a.validator.autoCreateRanges &&
                     (null != b.min && null != b.max &&
                      ...
                      null != b.minlength && null != b.maxlength &&
                          (b.rangelength = [b.minlength, b.maxlength], delete b.minlength,
                           delete b.maxlength)),
                 b
        },
        ...
        methods: {
          ...
          remote: function(b, c, d) {
            ...
            return this.settings.messages[c.name] || (this.settings.messages[c.name] = {}),
                   ...
                   g.old === b ? g.valid :
                                 (g.old = b, e = this, this.startRequest(c), f = {}, f[c.name] = b,
                                  a.ajax(a.extend(
                                      !0, {
                                        mode: 'abort',
                                        ...
                                        success: function(d) {
                                          ...
                                          j ? (i = e.formSubmitted, e.prepareElement(c),
                                               e.formSubmitted = i, e.successList.push(c),
                                               delete e.invalid[c.name], e.showErrors()) :
                                              (f = {}, h = d || e.defaultMessage(c, 'remote'),
                                               f[c.name] = g.message = a.isFunction(h) ? h(b) : h,
                                               e.invalid[c.name] = !0, e.showErrors(f)),
