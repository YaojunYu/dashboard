!function(t) {
  function o(t) {
    return 'undefined' == typeof t.which ? !0 :
                                           'number' == typeof t.which && t.which > 0 ? !t.ctrlKey &&
                !t.metaKey && !t.altKey && 8 != t.which && 9 != t.which && 13 != t.which &&
                16 != t.which && 17 != t.which && 20 != t.which && 27 != t.which :
                                                                                       !1
  }
  function i(o) {
    var i = t(o);
 ...
 t.material = {
   options: {
     ...
     autofill: !1,
     withRipples: [
       '.btn:not(.btn-link)', '.card-image', '.navbar a:not(.withoutripple)',
       '.footer a:not(.withoutripple)', '.dropdown-menu a', '.nav-tabs a:not(.withoutripple)',
       '.withripple', '.pagination li:not(.active):not(.disabled) a:not(.withoutripple)'
     ].join(','),
   ...
   input: function(o) {
     t(o ? o : this.options.inputElements).filter(':notmdproc').data('mdproc', !0).each(function() {
       ...
       if (t.each(n, function(t, n) {
         ...
         var a = o.attr('id'), r = '';
         a && (r = 'for=\'' + a + '\''), i.addClass('label-floating'),
   ...
   attachInputEventHandlers: function() {
     ...
     t(document)
         .on('change', '.checkbox input[type=checkbox]',
             function() {
               t(this).blur()
             })
         .on('keydown paste', '.form-control',
             function(i) {
   ...
   init: function(o) {
     ...
     t.fn.ripples && this.options.ripples && this.ripples(),
         ...
         document.arrive && this.options.arrive &&
         (t.fn.ripples && this.options.ripples && i.arrive(this.options.withRipples, function() {
    ...
    function(t, o, i, n) {
      ...
      e.prototype.init = function() {
        ...
        i.on('mousedown touchstart', function(n) {
          if (!r.isTouch() || 'mousedown' !== n.type) {
            ...
            if (a || s) {
              ...
              p.addClass('ripple').css({left: s, top: a, 'background-color': l}),
                  e.append(p), function() {
        ...
        var t = i.body || i.documentElement, o = t.style,
            e = o.transition !== n || o.WebkitTransition !== n || o.MozTransition !== n ||
            o.MsTransition !== n || o.OTransition !== n;
        return e
        ...
        t.off(),
            r.hasTransitionSupport() ? t.addClass('ripple-out') :
                                       t.animate(
                                           {opacity: 0}, 100,
                                           function() {
